...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<TestTablo> TestTablos { get; set; }

    public virtual DbSet<VwEnCokSatan> VwEnCokSatans { get; set; }

    public virtual DbSet<VwGetCustormerOrder> VwGetCustormerOrders { get; set; }

    public virtual DbSet<VwOrtHesap> VwOrtHesaps { get; set; }

    public virtual DbSet<VwShipperSpeedyEmpnancy> VwShipperSpeedyEmpnancies { get; set; }

    public virtual DbSet<VwWithEncr> VwWithEncrs { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-PDRSFJK\\SQLEXPRESS;Database=Northwind;Trusted_Connection=True;TrustServerCertificate=True; ");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.TestKolon1).HasName("PK__TestTabl__6C256813FDC10D79");
        ...
        modelBuilder.Entity<VwEnCokSatan>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VW_EN_COK_SATAN");

            entity.Property(e => e.CategoryName).HasMaxLength(15);
            entity.Property(e => e.OrderCount).HasColumnName("ORDER COUNT");
            entity.Property(e => e.ProductName).HasMaxLength(40);
        });

        modelBuilder.Entity<VwGetCustormerOrder>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VW_GET_CUSTORMER_ORDERS");
        ...
        modelBuilder.Entity<VwOrtHesap>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VW_ORT_HESAP");
        ...
        modelBuilder.Entity<VwShipperSpeedyEmpnancy>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VW_SHIPPER_SPEEDY_EMPNANCY");

            entity.Property(e => e.CustomerCompanyName)
                .HasMaxLength(40)
                .HasColumnName("CUSTOMER COMPANY NAME");
            entity.Property(e => e.FirstName).HasMaxLength(10);
            entity.Property(e => e.LastName).HasMaxLength(20);
            entity.Property(e => e.OrderDate).HasColumnType("datetime");
            entity.Property(e => e.OrderId).HasColumnName("OrderID");
            entity.Property(e => e.ShipperCompanyName)
                .HasMaxLength(40)
                .HasColumnName("SHIPPER COMPANY NAME");
        });

        modelBuilder.Entity<VwWithEncr>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VW_WITH_ENCR");
